...
const StudentDashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900">
      {/* Header Sidebar */}
      <div className="w-72 h-screen bg-gradient-to-b from-blue-100 via-blue-50 to-sky-100 border-r border-blue-200 flex flex-col shadow-sm">
        {/* Logo and Brand */}
        ...
        <nav className="flex-1 px-4 py-4">
          ...
          <div className="mt-8 pt-4 border-t border-blue-200/80">
            <h3 className="text-xs uppercase text-blue-700 mb-3 font-semibold">Quick Access</h3>
            <div className="space-y-1">
              <div
                onClick={handleAcademicRecordsClick}
                className="flex items-center gap-3 px-4 py-3 rounded-xl cursor-pointer transition-all text-left text-gray-600 hover:bg-white/50 hover:text-gray-900 font-medium"
              >
        ...
        <div className="px-4 py-4 border-t border-blue-200/80">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-sky-500 flex items-center justify-center text-white font-bold">
              {studentData?.avatar || "AJ"}
            </div>
            <div>
              <p className="text-sm font-medium text-gray-900">{studentData?.name || "Alex Johnson"}</p>
              <p className="text-xs text-gray-500">ID: {studentData?.studentId || "2024001"}</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            {bottomItems.map((item, i) => (
              <div
                key={i}
                onClick={() => handleSidebarClick(item)}
                className="flex items-center gap-3 px-4 py-2 rounded-xl cursor-pointer hover:bg-white/50 text-gray-600 hover:text-gray-900 font-medium transition-all"
              >
