    ...
    <div className="flex h-screen bg-gray-50 text-gray-900">
      ...
      <div className="flex-1 p-6 overflow-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">Upload and track assignments</p>
        </div>

        {/* UPLOAD BOX (MATCH CARD STYLE) */}
        <div className="bg-white p-6 rounded-xl shadow-lg border-l-4 border-blue-500 mb-6">
          <h2 className="text-lg font-semibold mb-4">Upload Submission</h2>
        ...
        {/* CARDS (MATCH TASK STYLE) */}
        <div className="grid md:grid-cols-3 gap-6 mb-6">

          <Card title="Total" value={submissions.length} color="blue" />
          <Card title="Submitted" value={submissions.filter(s => s.status === "submitted").length} color="green" />
          <Card title="Graded" value={submissions.filter(s => s.status === "graded").length} color="purple" />
