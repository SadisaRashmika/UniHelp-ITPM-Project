...
const TasksPage = () => {
  ...
  // MOCK TASK DATA (same structure style as submissions)
  ...
  // FILTER LOGIC (same as submissions)
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-900">
      ...
      {/* MAIN CONTENT (MATCHED STRUCTURE) */}
      <div className="flex-1 flex flex-col p-6 overflow-auto">
        ...
        {/* SUMMARY CARDS (MATCH STYLE) */}
        <div className="grid md:grid-cols-4 gap-6 mb-6">

          <Card title="Total Tasks" value={tasks.length} color="blue" icon={BookOpen} />
          <Card title="Pending" value={tasks.filter(t => t.status === "pending").length} color="yellow" icon={Clock} />
          <Card title="Completed" value={tasks.filter(t => t.status === "completed").length} color="green" icon={CheckCircle} />
          <Card
            title="Due Soon"
