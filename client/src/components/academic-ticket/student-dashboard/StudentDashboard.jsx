  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        // Convert quizzes to deadline format
        const quizDeadlines = quizzes.map((quiz, index) => ({
          id: quiz.id,
          title: quiz.title,
        ...
        // Mock deadlines for assignments and practicals
        const mockDeadlines = [
          {
            id: 1,
      ...
      <div className={`w-72 h-screen flex flex-col overflow-y-auto ${lightMode ? "bg-gray-800" : "bg-gray-900 text-white"}`}>
        ...
        <div className="p-6 border-b border-gray-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">Academic Dashboard</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-gray-700">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm font-medium text-white">{studentData?.name || "Alex Johnson"}</p>
              <p className="text-xs text-gray-400">ID: {studentData?.studentId || "2024001"}</p>
            </div>
          </div>
