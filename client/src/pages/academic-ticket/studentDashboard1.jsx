...
const StudentDashboard = ({ embedded = false }) => {
  ...
  const sidebarItems = [
    ...
    { icon: BookOpen, label: "Tasks", key: "tasks" },
    { icon: FileText, label: "Submissions", key: "submissions" },
    { icon: Briefcase, label: "Jobs", key: "jobs" },
    { icon: Users, label: "Resume", key: "resume" },
    { icon: Bell, label: "Notifications", key: "notifications" },
  ];

  const bottomItems = [{ icon: Settings, label: "Settings", key: "settings" }];
      ...
      return (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Track your upcoming academic tasks and deadlines.</p>
          </div>
      ...
      return (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Review your recent submissions and results.</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="space-y-4">
              {recentGrades.map((grade) => (
                <div key={grade.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className={`text-xl font-bold ${getGradeColor(grade.grade)}`}>{grade.grade}</p>
      ...
      return (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Explore opportunities and career-related updates.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Frontend Intern</h3>
              <p className="text-sm text-gray-600">ABC Tech · Colombo · Internship</p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Backend Developer</h3>
              <p className="text-sm text-gray-600">XYZ Solutions · Remote · Full-time</p>
            </div>
          </div>
        </div>
      );
      ...
      return (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Keep your profile and resume details up to date.</p>
          </div>
          <div className="bg-white rounded-xl shadow-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
              <p><span className="font-semibold text-gray-700">Name:</span> {studentData?.name || "Alex Johnson"}</p>
              <p><span className="font-semibold text-gray-700">Student ID:</span> {studentData?.studentId || "2024001"}</p>
              <p><span className="font-semibold text-gray-700">Program:</span> {studentData?.program || "Computer Science"}</p>
              <p><span className="font-semibold text-gray-700">Email:</span> {studentData?.email || "alex.johnson@university.edu"}</p>
            </div>
          </div>
        </div>
      );
    ...
    if (activeTab === "settings") {
      return (
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <p className="text-sm text-gray-500 mt-2">Personalization options are available from your profile settings panel.</p>
        </div>
      );
    }
